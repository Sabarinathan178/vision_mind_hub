...
router.get('/auth/google/student/callback', passport.authenticate('student', { failureRedirect: '/student/signup' }), (req, res) => {
    res.redirect('http://0.0.0.0:3000/student/dashboard?token=' + req.user.tokens[req.user.tokens.length-1].token)
})
...
router.get('/payment/success/', saveData, (req, res) => {
    res.redirect('http://0.0.0.0:3000/student/dashboard/classrooms')
})

router.get('/payment/cancel', (req, res) => {
    res.redirect('http://0.0.0.0:3000/student/dashboard')
})
