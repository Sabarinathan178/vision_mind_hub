...
const signUp = async(req, res) => {
    ...
    try{
        ...
        const verificationLink = `http://localhost:4000/teacher/verify/${token}`
...
module.exports = {signUp, login, userPanel, emailVerification, updateProfile, getAllTeachers, deleteTeacher, getTeacherCount, getProfile, searchTeacher, getAppointments, cancelAppointment, acceptAppointment, modifyAppointment}
