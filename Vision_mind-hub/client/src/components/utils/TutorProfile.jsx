                            ...
                            <div className='pt-3'>
                                <div className='row'>
                                    ...
                                    <div className='d-flex align-items-center mb-2'>
                                        ...
                                        <span className='mx-3'> <a href={teacher.experience.interest} target='_blank'>My career profile link</a></span> 
                                    </div>
                                    <div className='d-flex align-items-center mb-2'>
                                        <i className="mx-3 fa-solid fa-chalkboard-user text-dark"></i>
                                        <span className='mx-3'>I can teach <strong>{teacher.experience.subjectType} subject</strong> to  students.</span>
                                    </div>
                                    <div className='d-flex align-items-center mb-2'>
