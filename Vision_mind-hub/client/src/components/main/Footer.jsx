  ...
  return (
    ...
    <footer className="text-center text-lg-start bg-light text-muted">
            ...
            <div className="container text-center text-md-start mt-5">
                <div className="row mt-3">
                    ...
                    <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <h6 className="text-uppercase fw-bold mb-4">VISION MIND HUB INC.</h6>
                        <p>
                            Vision mind is an online platform that connects students with qualified and experienced tutors who can provide personalized one-on-one or group lessons in a variety of subjects.
                        </p>
                    </div>
                    ...
                    <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i className="fas fa-home me-3"></i> sri Eshwar,Coimbatore</p>
                        <p><i className="fas fa-envelope me-3"></i> sece@official.com </p>
                        <p><i className="fas fa-phone me-3"></i> + 91 6381794112</p>
        ...
        <div className="text-center p-4 bg-info text-light">
            © 2023 Copyright: 
            <a className="text-reset fw-bold" href=""> vision mind</a>
        </div>
