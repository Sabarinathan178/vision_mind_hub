...
function EditProfile() {
  ...
  const handleFileChangeProof = (e) => {
    const file = e.target.files[0];
    const reader = new FileReader();
    reader.readAsDataURL(file);
    reader.onloadend = () => {
      setUpdateProfile({...teacher, IdProof: reader.result})
    }
    console.log(reader.resutl);
  }
              ...
              <div class="accordion-body">
                ...
                <div className='container px-4'>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                      <div className="form-group">
                          <label for="Interest" className="form-label mt-4">Your Career Profile Link</label>
                          <input type="text" className="form-control text-muted" id="Interest" placeholder="Your profile link?" name="interest" value={experience.interest} onChange={handleChangeInputExperience}/>
                        </div>   
                    ...
                    <div className="row">
                      <div class="form-group">
                        <label for="formFile" class="form-label mt-4">Staff ID Proof</label>
                        <input class="form-control" type="file" name="profile" accept="image/*" id="formFile" onChange={handleFileChangeProof} />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <div class="form-group">
                          <label for="SubjectType" class="form-label mt-1">Where you will get experienced or currently working?</label>
                          <select multiple class="form-select" id="SubjectType"  name="subjectType"value={experience.subjectType} onChange={handleChangeInputExperience}>
                            <option>Choose...</option>
                            <option value="Science">IIT</option>
                            <option value="Arts">NIT</option>
                            <option value="Commerce">CEG</option>
                            <option value="Commerce">CIT</option>
                            <option value="Commerce">PSG</option>
                            <option value="Commerce">SSN</option>
                            <option value="Commerce">Thiagarajar</option>
                            <option value="Commerce">ACT</option>
