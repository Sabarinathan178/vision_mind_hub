    ...
    <>
      {
        ...
        <div className='my-5'>
          ...
          <section className='mb-4'>
            <h3 className='mb-3'>Scholarship details</h3>
            <hr />
            <div className='row'>   
              {
                    ...
                    <div className='col-3 mb-3' key={index}>
                      <div className='card'>
                        <div className='card-body p-0'>
                          <img src={item.urlToImage} alt={item.title} className='card-img-top ' style={{ width: '300px', height: '200px' }} />
                          <div className='p-3'>
                            <h5 className='card-title'>{item.title}</h5>
                            <p className='card-text'>
                            {
                              item.description.length > 220 ? item.description.substring(0, 220) + '...' : item.description
                            }
                            </p>
                            <a href={item.url1} target='_blank'><button>show more</button></a>
                          </div>
                        </div>
                      </div>
                    </div>
