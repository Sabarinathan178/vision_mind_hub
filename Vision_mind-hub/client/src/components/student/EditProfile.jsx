...
function EditProfile() {
  ...
  const handleFileChangeProof = (e) => {
    ...
    reader.readAsDataURL(file);
    reader.onloadend = () => {
      setUpdateProfile({...updateProfile, IdProof: reader.result})
    }
  }
                ...
                <div className='row align-items-end'>
                  <div className='col-md-6'>
                    <div class="form-group">
                      ...
                      <input class="form-control" type="file" id="formFile" accept="image/*" name="profile" onChange={handleFileChangeProfile}/> 
                    </div>
                  </div>
                  ...
                  <div className='col-md-4'>
                    <div class="form-group">
                      ...
                      <select class="form-select" id="updateLanguage" name='language' onChange={inputHandler} value={updateProfile.language}>
                        ...
                        <option value="Sindhi">Punjabi</option>
                        <option value="Other">Other</option>
                      </select>
                    </div>
                  </div>
