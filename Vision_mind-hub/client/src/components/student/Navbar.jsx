  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container">
        <Link className="navbar-brand" href="#">VISION MIND</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarColor01">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <Link className={`nav-link ${activeTab === 'Self study' ? 'active' : ''}`} to="http://localhost:4500" onClick={() => handleTabClick('SelfStudy')}>Self Study</Link>
            </li>
            <li className="nav-item">
              <Link className={`nav-link ${activeTab === 'Discussion' ? 'active' : ''}`} to="/student/dashboard/Chat" onClick={() => handleTabClick('Dicussion')}>Discussion</Link>
            </li>
            <li className="nav-item">
